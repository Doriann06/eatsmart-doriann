...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 sep. 2025 à 23:43
...
--
-- Base de données : `eeatsmart_bdd_doriann`
--
CREATE DATABASE IF NOT EXISTS `eeatsmart_bdd_doriann` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `eeatsmart_bdd_doriann`;
